...
module.exports = function(app) {
  ...
  */
  ...
  const forms = [
    { name: 'Détachement', committee: 'cap', code: 'cap01', requiredAttachments: ['Demande de l\'agent'] },
    { name: 'Détachement sur emploi fonctionnel', committee: 'cap', code: 'cap02' , requiredAttachments: ['Demande de l\'agent']},
